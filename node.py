...
def locate():
    while (True):
        ...
        with sr.Microphone() as source2:
            ...
            #location = MyText
            # add edges
            g.add_edge('MA101', 'MA102')
            g.add_edge('MA102', 'MA103')
            g.add_edge('MA103', 'MA104')
            g.add_edge('MA104', 'MA105')
            g.add_edge('MA104', 'MA105')
            g.add_edge('MA104', 'MA105')
            g.add_edge('MA105', 'MA106')
            g.add_edge('MA106', 'MA107')
            g.add_edge('MA107', 'MA108')
            g.add_edge('MA108', 'MA109')
            g.add_edge('MA109', 'MA110')
            g.add_edge('MA110', 'MA111')
            g.add_edge('MA111', 'MA112')
            g.add_edge('MA112', 'MA113')
            g.add_edge('MA113', 'MA114')
            g.add_edge('MA114', 'MA115')
            g.add_edge('MA115', 'MA101')
            # g.add_edge('MA105','g')
            # g.add_edge('MA115','MA111')
            # g.add_edge('MA111','g')
